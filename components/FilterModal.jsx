  ...
  return (
    ...
    >
      <AppView isSAfe>
        ...
        >
          {title === "فیلترها" && availableFilters && (
            <FlatList
              ...
              renderItem={({ item }) => (
                <FilterOptionItem
                  ...
                  isAvailableValue={onlyAvailabales}
                  onIsAvailableChange={() => {
                    setOnlyAvailabels(!onlyAvailabales);
                    // onIsAvailbleChange()
                  }}
                />
              )}
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <FilterSubOption
                    value={item}
                    onPress={() => onSubItemPress(item , activeFilter.id)}
                    // isChecked={
          ...
          {title === "محدوده قیمت موردنظر" && (
            <View style={{ marginTop: "10%" }}>
              ...
              >
                <Slider
                  min={currentCategory.minProductPrice}
                  max={currentCategory.maxProductPrice}
                  step={100000}
