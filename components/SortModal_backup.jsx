      ...
      <AppView isSAfe>
        ...
        >
          <FlatList
            ...
            ItemSeparatorComponent={() => <Line color={colors.midleLightGray} />}
          />
        </View>
        <TouchableOpacity
          style={[styles.rowFlex, { height: "5%", paddingHorizontal: 20,backgroundColor : colors.white }]}
          onPress={onRequestClose}
        >
          <Text
            style={{
